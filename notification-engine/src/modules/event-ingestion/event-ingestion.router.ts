...
import { NotificationJobData } from '../../common/interceptors/notification-job.interface';
...
export class EventRouter {
  ...
  async dispatch(event:NotificationEventDto , NotificationId : string) : Promise<void>{
    ...
    for (const channel of route.channels){
      ...
      await this.pickUpQueue(channel).add(channel , job , {priority : route.priority});
